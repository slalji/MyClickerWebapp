 ...
 */
	...
	$usr->storeFormValues( $_POST );         
	 $ch = $usr->register();echo "user: ".$usr->username;
            	...
            	<form method="post" id="register-form">
                	<ul>
                    	<li>
                            ...
                            <input type="email" id="email" maxlength="30" required autofocus name="username" placeholder="Username" "/>
                        ...
                        <li>
                        	<label for="usn">Course Number : </label>
                                <input type="text" id="course" maxlength="30" required autofocus name="course" placeholder="Stat 101" />
                    	</li>
                        <li>
                        	<label for="usn">Course Name : </label>
                                <input type="text" id="crname" maxlength="30" required  name="crname" placeholder="Statistics" />
                    	</li>
                    	<li class="buttons">
